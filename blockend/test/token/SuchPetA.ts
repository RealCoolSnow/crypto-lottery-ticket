...
import { deployContract, getBlockTimestamp, mineBlockTimestamp, offsettedIndex } from "../helpers";
  ...
  function () {
    ...
    context(`${contract}`, function () {
      beforeEach(async function () {
        ...
        this.receiver = await deployContract("SuchPetAReceiver", [RECEIVER_MAGIC_VALUE, this.erc721a.address]);
...
describe("SuchPetA", createTestSuite("SuchPetA", ["Such Pet A", "SuchPetA"]));
